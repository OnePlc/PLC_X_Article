...
(NULL, 'currency', 'Our Price', 'price_us', 'article-finance', 'article-single', 'col-md-2', '', '', 0, 1, 0, '', '', ''),
...
('article-finance', 'article-single', 'Finance', 'Financial', 'fas fa-money-check-alt', '', 1, '', '');
